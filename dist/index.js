...
const run_service_1 = __nccwpck_require__(830);
...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (!serviceName)
            throw new Error("A service-name must be given");
        const command = core_1.getInput("command");
        return yield run_service_1.runService(serviceName, command);
    });
}
run()
...
function runService(serviceName, containerCommand) {
    return __awaiter(this, void 0, void 0, function* () {
        let args = [
            "-f",
            "docker-compose.yml",
        ...
        const command = child_process_1.spawn("docker-compose", args, { stdio: "inherit" });
